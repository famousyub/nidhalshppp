<template>
    ...
    <main>
    <div class="header-2" id="allTheNav"> 
      
      
      
       <nav   class="bg-white py-2 md:py-4"  style="background-color:  #3b5998;">
      <b-navbar toggleable="lg" type="light" variant="light" style="background-color:  #3b5998;"  
      >
        ...
        <b-container>
          ...
          <b-collapse id="nav-top-header-collapse" is-nav>
            <b-navbar-nav class="mr-auto">
              ...
              <b-nav-form v-on:submit.prevent="search" class="ml-auto mr-2" v-if="userLoggedIn">
                <span>
